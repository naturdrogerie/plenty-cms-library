...
if(a(e).attr("name"))if("checkbox"==a(e).attr("type")){var f=[];a(c).find('[name="'+a(e).attr("name")+'"]:checked').each(function(b,c){f.push(a(c).val())}),b(a(e).attr("name"),f)}else"radio"==a(e).attr("type")?a(e).is(":checked")&&b(a(e).attr("name"),a(e).val()):b(a(e).attr("name"),a(e).val())}),d}}(jQuery,PlentyFramework),PlentyFramework.compile();var plenty=PlentyFramework.getInstance();jQuery(document).ready(function(){plenty.bindDirectives()});
//# sourceMappingURL=plentymarketsCMStools-1.0.12.min.js.map